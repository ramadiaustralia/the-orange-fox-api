...
export async function POST(
  ...
  if (admin.badge !== "owner") {
    return NextResponse.json({ error: "Only the owner can add project members" }, { status: 403 });
  }
...
export async function DELETE(
  ...
  if (admin.badge !== "owner") {
    return NextResponse.json({ error: "Only the owner can remove project members" }, { status: 403 });
  }
