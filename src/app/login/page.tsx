...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dark via-dark-soft to-charcoal relative overflow-hidden">
      ...
      <div
        className="absolute top-0 right-[15%] w-px h-32 pointer-events-none opacity-10"
        style={{
          background: "linear-gradient(to bottom, transparent, rgba(212,105,42,0.5), transparent)",
        }}
      />
      <div
        className="absolute bottom-0 left-[20%] w-px h-24 pointer-events-none opacity-10"
        style={{
          background: "linear-gradient(to top, transparent, rgba(212,105,42,0.4), transparent)",
        }}
      />
      ...
      <div
        ...
        style={{ animation: "heroSlideUp 0.8s cubic-bezier(0.16, 1, 0.3, 1) both" }}
      >
        {/* Badge */}
        ...
        {/* Login Card — glass-morphism on dark background */}
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          <h2 className="font-heading text-lg font-semibold text-white mb-1">Welcome back</h2>
          <p className="text-sm text-white/50 mb-6">Sign in to manage your content</p>
